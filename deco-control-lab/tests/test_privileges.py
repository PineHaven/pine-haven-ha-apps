...
from deco_lab.privileges import PrivilegeDropError, drop_process_privileges


class PrivilegeDropTests(unittest.TestCase):
    @patch("deco_lab.privileges.os.setuid")
    @patch("deco_lab.privileges.os.setgid")
    @patch("deco_lab.privileges.os.setgroups")
    @patch("deco_lab.privileges.pwd.getpwnam")
    @patch("deco_lab.privileges.os.geteuid", return_value=1000)
    ...
    @patch("deco_lab.privileges.os.umask")
    @patch("deco_lab.privileges.os.geteuid", side_effect=[0, 1000])
    @patch("deco_lab.privileges.pwd.getpwnam")
    @patch("deco_lab.privileges.os.setgroups")
    @patch("deco_lab.privileges.os.setgid")
    @patch("deco_lab.privileges.os.setuid")
    ...
    @patch("deco_lab.privileges.os.geteuid", return_value=0)
    @patch("deco_lab.privileges.pwd.getpwnam", side_effect=KeyError)
