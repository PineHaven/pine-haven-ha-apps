...
class UiTests(unittest.TestCase):
    def test_ingress_ui_is_self_contained_and_has_live_sections(self):
        ...
        self.assertIn("2.4 GHz coexistence laboratory", UI_HTML)
        self.assertIn("Channel and width preflight", UI_HTML)
        self.assertIn("No radio write can run from this release", UI_HTML)
