...
class SanitizerTests(unittest.TestCase):
    def test_snapshot_keeps_alias_but_discards_identifiers_and_client_names(self):
        devices = [
            {
        ...
        result = build_snapshot(
            ...
            node_aliases={"AA-BB-CC-DD-EE-FF": "Living Room"},
        )
        ...
        self.assertEqual(result["mesh_health"]["signal"]["band5"]["average"], 2.0)
        self.assertEqual(
        ...
        self.assertEqual(result["observed_fields"]["client_records"]["mac"], ["string"])
        self.assertEqual(
