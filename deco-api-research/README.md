...
Version 0.4.x is a bounded health-summary probe. It is disarmed by default and cannot
...
acknowledgement. Version 0.4.x performs one three-read cycle and then remains idle;
